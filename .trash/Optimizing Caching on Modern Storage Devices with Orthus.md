...
![](attachment/6c58def9ab2ce9b4fc81c67a54bdc52e.png)
...
![](attachment/1f82d1f615eb35a6b5105776781ebc30.png)
- 延迟在降低
- 带宽差距不明确
为了更好地了解这些设备的性能重叠，图 2 显示了在改变并发级别的情况下，针对 4KB 读/加载和写/存储的各种实际设备的吞吐量。

![](attachment/58d83786a4fdcd926177251dd0151cc1.png)
读：
- 低并发读：设备对之间有显著差异
...
$$
## 解析模型
![](attachment/906f37a27de077acfca38fbf878c653f.png)
$$
...
1. 设备性能存在上限
2. 增加负载不会降低性能
3. 设备性能达到上限前，随着负载的提高，$D_{hi}$ 的性能增幅比 $D_{lo}$ 高。
经典缓存尝试找到一个工作集使得命中率最高。
### 架构
![](attachment/3664a87ecca524d55d7f354e3df6f9d0.png)
...
![](attachment/8ee78f0e0b90dae8606780a39a671659.png)
...
![](attachment/b2481d44378fb0d4002e726320949d8b.png)

![](attachment/5eeaab409e0e5898f42369c7a8f8a5a2.png)

![](attachment/ac03ab4e232b7d6dadf48d6702464456.png)
# 结论
