...
Markdown Content:
[](https://example.com/#%E5%89%8D%E7%BD%AE%E6%9D%A1%E4%BB%B6 "前置条件")前置条件
------------------------------------------------------------------------
...
[](https://example.com/#%E5%AE%89%E8%A3%85-Certbot "安装 Certbot")安装 Certbot
--------------------------------------------------------------------------
...
[](https://example.com/#%E8%8E%B7%E5%8F%96%E7%94%A8%E6%88%B7-API-%E4%BB%A4%E7%89%8C "获取用户 API 令牌")获取用户 API 令牌
-------------------------------------------------------------------------------------------------------------
...
[](https://example.com/#%E7%AD%BE%E5%8F%91%E8%AF%81%E4%B9%A6 "签发证书")签发证书
------------------------------------------------------------------------

\`\`\`
sudo certbot certonly \
    --dns-cloudflare \
    --dns-cloudflare-credentials ~/.cloudflare.ini -d \
...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\`\`\`
[![Image 1](blob:http://localhost/9cd106354ea9a736ae989f469a39d4cd)](https://fcc-cd.dev/article/engineering/certbot-issues-wildcards-private-network/6af9d79b7229c6957b734c0920e4c1753af89b3a.png)
...
Trigger: Mon 2024-05-13 01:49:57 CST; 2h 7min left
...
[](https://example.com/#%E9%85%8D%E7%BD%AE-Nginx-%E8%AF%BB%E5%8F%96%E8%AF%81%E4%B9%A6 "配置 Nginx 读取证书")配置 Nginx 读取证书
-------------------------------------------------------------------------------------------------------------------
...
[](https://example.com/#%E9%85%8D%E7%BD%AE-%E5%86%85%E7%BD%91-DNS-%E6%9C%8D%E5%8A%A1%E5%99%A8 "配置内网 DNS 服务器")配置内网 DNS 服务器
---------------------------------------------------------------------------------------------------------------------------

需要在路由器指定内网 DNS 服务器，我用的是小米路由器

[![Image 2](blob:http://localhost/02f98bc2d5164eb125d2909896764290)](https://fcc-cd.dev/article/engineering/certbot-issues-wildcards-private-network/77adb6747a403f1f6b3ab0d66e1e21939b47c885.png)

192.168.2.166 我的 DNS 服务器的内网 IP。

配置内网 DNS 服务器，我用的是 Adguard

[![Image 3](blob:http://localhost/7e3af8bd3d12ec2766d50547fd663aa8)](https://fcc-cd.dev/article/engineering/certbot-issues-wildcards-private-network/5354869112456c80ee49e77acc2a65fbc0df4c4b.png)
...
[![Image 4](blob:http://localhost/81212f12e54da4679803f4694037a8f5)](https://fcc-cd.dev/article/engineering/certbot-issues-wildcards-private-network/a176571864797e95b492f33487e6085947eaa2ec.png)

就可以在内网使用 https，可以使用很多高级 web 特性了。

[](https://example.com/#%E6%80%BB%E7%BB%93 "总结")总结
--------------------------------------------------
...
[![Image 5](blob:http://localhost/a115dad56b6c936871086e68051a0c77)](https://fcc-cd.dev/article/engineering/certbot-issues-wildcards-private-network/2c730e26d69d603ab2e7458da867f22b4752fee2.png)
