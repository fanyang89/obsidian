...
source: "https://www.sabrina.dev/p/ultimate-ai-coding-guide-claude-code"
author:
  - "[[Sabrina Ramonov 🍄]]"
published: 2025-07-06
created: 2025-08-03
description: "How I use Claude Code, the ultimate AI coding tool, to implement new features in an existing complex codebase with many users. Walk through my CLAUDE.md AI coding rules file."
tags:
  - "clippings"
---
...
10. When I’m happy with the code, I type \`qux\` which tells Claude:
    ...
    ![](https://www.sabrina.dev/p/%7B%22src%22:%22https://substack-post-media.s3.amazonaws.com/public/images/e49c5ca4-e001-4188-bb5b-5d8198cf7cdf_580x780.png%22,%22srcNoWatermark%22:null,%22fullscreen%22:null,%22imageSize%22:null,%22height%22:780,%22width%22:580,%22resizeWidth%22:380,%22bytes%22:593022,%22alt%22:null,%22title%22:null,%22type%22:%22image/png%22,%22href%22:null,%22belowTheFold%22:true,%22topImage%22:false,%22internalRedirect%22:%22https://www.sabrina.dev/i/167596756?img=https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe49c5ca4-e001-4188-bb5b-5d8198cf7cdf_580x780.png%22,%22isProcessing%22:false,%22align%22:null,%22offset%22:false})
...
In the [Youtube video](https://www.youtube.com/watch?v=SDiDkK0r-9c), I walk through this entire process implementing a real feature in my codebase. I encourage you to follow along with your own small feature.
...
1/ **If you want to grow on social media** and scale your business in coaching, consulting, speaking, selling apps, or digital products… **check out** **_[Blotato](http://www.blotato.com/)_**

2/ Free AI courses & playbooks **_[here](https://www.sabrina.dev/p/start)_**

3/ Free **_[AI prompts](https://prompts.sabrina.dev/)_** & **_[AI automations](https://agents.sabrina.dev/)_**
